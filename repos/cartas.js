    ...
    if (idTP) {
        ...
        repositorios.forEach(async ({id, full_name, titulo, descripcion, id_usuario}) => {
            ...
            if ((id_usuario_en_maquina) && (contributors.some(({id})=> id == id_usuario_en_maquina) || id_usuario == id_usuario_en_maquina)) {
                ...
                floats.className = "absolute right-4 bottom-4 flex gap-4 transition-all"
                ...
                editBtn.onclick = () => {
                    ...
                    form.toggleAttribute("aria-disabled")
                    tituloElement.toggleAttribute("disabled")
                    descripcionElement.toggleAttribute("disabled")
